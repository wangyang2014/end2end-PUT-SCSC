...
class Separator(object):
    ...
    def seperate(self, spectra, cmvn=None, apply_log=True):
        ...
        mix_spec, spk1_spec, spk2_spec, speaker_1, speaker_2, Orth_const = self.nnet(
            th.tensor(input_spectra, dtype=th.float32, device=self.location),None,
            per_train=False)
        ...
        return mask,[spectra * spk_mask[0].cpu().data.numpy() for spk_mask in mask]
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        "--config", type=str, default=r"conf\train.yaml", help="Location of training configure files")
    parser.add_argument(
        "--state_dict", type=str,default=r"2spk_pit_a\epoch.40.pkl", help="Location of networks state file")
    parser.add_argument(
        "--wave_scp",
        type=str,
        default=r"create_scp\tt_mix.scp",
